...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        User localUser = userRepository.findByEmail(username).orElseThrow(() -> new UsernameNotFoundException("Trazeni korisnik ne postoji!"));

        return new org.springframework.security.core.userdetails.User(localUser.getEmail(),
